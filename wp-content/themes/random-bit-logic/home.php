 ...
 *
 * WordPress uses this template for the page designated as the "Posts page"
 * in Settings > Reading. Page template assignments are ignored for that page,
 * so this file ensures the Insights layout is used.
 */
